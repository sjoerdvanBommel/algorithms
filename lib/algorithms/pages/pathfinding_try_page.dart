...
import 'package:algorithms/algorithms/components/grid.dart';
import 'package:algorithms/algorithms/enums/cell_action.dart';
                ...
                Grid(
                  ...
                  onSelectCell: (i) {
                    setState(() {
                      ...
                      if (clickedCalculate)
                        calculate(widget.algorithm, animated: false);
                    });
                  },
